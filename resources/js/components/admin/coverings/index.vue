<template>
    <div>
      <ol class="breadcrumb 2">
              ...
              <li class="active"><strong>Recubrimientos</strong></li>
          </ol>
          <h2 class="margin-bottom">Recubrimientos</h2>
  
          <div class="row">
              <div class="col-md-12">
                  <div id="toolbar">
                      <router-link to="/coverings/edit">
    ...
    methods:{
      mounthTable(){
        ...
        jQuery('#table').on('click-row.bs.table',(row,data)=>{
          this.$router.push('/coverings/edit/'+data.id);
        });
      ...
      deleteRows:function(){
        ...
        alertify.confirm("Alerta!","¿Seguro que deseas borrar "+rows.length+" registros?",()=>{
          ...
          axios.delete(tools.url('/api/admin/coverings'),{data:params})
          .then((response)=>{
