<template>
  <div>
    <ol class="breadcrumb 2">
      ...
      <li class="active"><strong>Paquetes</strong></li>
    </ol>
    <h2 class="margin-bottom">Paquetes</h2>

    <div class="row">
      <div class="col-md-12">
        <div id="toolbar">
          <router-link to="/packages/edit">
  ...
  methods: {
    mounthTable() {
          ...
          },
          {
            ...
            formatter: function (value, row, index) {
              return `<div style="display: flex;justify-content: center;">
                <div style="width: 30px; height: 30px; background-color: ${value};">
                </div>
                </div>`;
            },
          },
      ...
      jQuery('#table').on('click-row.bs.table', (row, data) => {
        this.$router.push('/packages/edit/' + data.id);
      });
    ...
    deleteRows: function () {
      ...
      alertify.confirm("Alerta!", "¿Seguro que deseas borrar " + rows.length + " registros?", () => {
        ...
        axios.delete(tools.url('/api/admin/packages/multiple'), { data: params })
          .then((response) => {
